...
CREATE ROLE ice_cream_reader COMMENT = 'Able to read ice_cream_database';
CREATE ROLE ice_cream_writer COMMENT = 'Able to do CRUD operations on ice_cream_database';
CREATE ROLE ice_cream_analyst COMMENT = 'Able to do create views on ice_cream_database';

SHOW ROLES;


USE ROLE securityadmin;
GRANT USAGE ON WAREHOUSE andres_wh TO ice_cream_reader;
...
GRANT ROLE ice_cream_writer TO USER andres1811;
